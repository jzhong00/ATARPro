...
const SubjectTable: React.FC<SubjectTableProps> = ({
  ...
  return (
    <>
        ...
        <table className="min-w-full divide-y divide-gray-200 table-fixed">
          <thead className="bg-gray-50">
            <tr>
              {rangeMode ? (
                <>
                  <th scope="col" className="px-1.5 2xl:px-3 py-1.5 2xl:py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-5/12">Subject</th>
                  <th scope="col" className="px-1.5 2xl:px-2 py-1.5 2xl:py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-1/12">Lower result</th>
                  <th scope="col" className="px-1.5 2xl:px-2 py-1.5 2xl:py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-1/12">Result</th>
                  <th scope="col" className="px-1.5 2xl:px-2 py-1.5 2xl:py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-1/12">Upper result</th>
                  <th scope="col" className="px-1.5 2xl:px-2 py-1.5 2xl:py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-2/12">Scaled Range</th>
                </>
              ) : (
                <>
                  <th scope="col" className="px-1.5 2xl:px-3 py-1.5 2xl:py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-6/12">Subject</th>
                  <th scope="col" className="px-1.5 2xl:px-2 py-1.5 2xl:py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-3/12">Result</th>
                  <th scope="col" className="px-1.5 2xl:px-2 py-1.5 2xl:py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-2/12">Scaled</th>
                </>
              )}
              <th scope="col" className="px-1 py-1.5 2xl:py-2 w-1/12"></th>
            </tr>
          </thead>
          <tbody className="bg-white divide-y divide-gray-200">
            {subjectRows.map((row) => (
              <tr key={row.id}>
                {/* Subject Input */}
                <td className={`px-1.5 2xl:px-3 py-1 2xl:py-1.5 whitespace-nowrap border border-gray-200 ${!rangeMode ? "w-6/12" : "w-5/12"}`}>
                  <SubjectInput
                    value={row.subject}
                ...
                {rangeMode ? (
                  <>
                    {/* Lower Result Input */}
                    <td className="px-1.5 2xl:px-2 py-1 2xl:py-1.5 whitespace-nowrap border border-gray-200 w-1/12">
                      <ResultInput
                  ...
                  <>
                    {/* Single Result Input */}
                    <td className="px-1.5 2xl:px-2 py-1 2xl:py-1.5 whitespace-nowrap border border-gray-200 w-3/12">
                      <ResultInput
                        value={row.rawResult}
                        onBlur={(val) => onResultChange(row.id, val)} // Use onBlur
                        validationRule={row.validationRule}
                ...
                <td className={`px-1.5 2xl:px-2 py-1 2xl:py-1.5 whitespace-nowrap text-sm 2xl:text-base text-gray-500 text-center border border-gray-200 ${rangeMode ? "w-2/12" : "w-2/12"}`}>
                  {(() => {
                ...
                {/* Delete Button */}
                <td className="px-1 py-1 2xl:py-1.5 whitespace-nowrap text-center text-sm font-medium border border-gray-200 w-1/12">
                  <button
      ...
      <button
        onClick={onAddRow}
        className="text-sm 2xl:text-base text-blue-600 hover:text-blue-800 self-start"
      >
