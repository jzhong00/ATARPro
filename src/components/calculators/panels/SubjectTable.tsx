            ...
            <tr>
              {rangeMode ? (
                <>
                  ...
                  <th scope="col" className="px-2 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-2/12">Scaled Range</th>
                </>
              ) : (
                <>
              ...
              <th scope="col" className="px-1 py-2 w-1/12"></th>
            </tr>
          </thead>
            ...
            {subjectRows.map((row) => (
              <tr key={row.id}>
                ...
                {rangeMode ? (
                  <>
                    {/* Lower Result Input */}
                    <td className="px-2 py-1.5 whitespace-nowrap border border-gray-200 w-1/12">
                      <ResultInput
                ...
                <td className={`px-2 py-1.5 whitespace-nowrap text-sm text-gray-500 text-center border border-gray-200 ${rangeMode ? "w-2/12" : "w-2/12"}`}>
                  {(() => {
                ...
                {/* Delete Button */}
                <td className="px-1 py-1.5 whitespace-nowrap text-center text-sm font-medium border border-gray-200 w-1/12">
                  <button
