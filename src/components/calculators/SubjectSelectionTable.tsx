...
const SubjectSelectionTable = ({
  ...
  return (
    <div className="flex-none w-[500px] bg-white rounded-xl shadow-md p-4 flex flex-col">
      <button 
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            {subjects.map(subject => (
              <tr key={subject}>
                <td className="p-1.5 text-left font-medium text-gray-700 border-b border-gray-200 sticky left-0 bg-white z-[1] min-w-[250px] pr-4">
