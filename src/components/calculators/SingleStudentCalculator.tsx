  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="container mx-auto p-2 2xl:p-4">
        ...
        {!isGuestMode && (
          <div className="flex items-center justify-between bg-white rounded-lg shadow-sm p-1.5 2xl:p-3 border border-gray-200 mb-3">
        ...
        <div className="flex flex-col lg:flex-row gap-2 2xl:gap-4">
          <div className="lg:w-3/5 flex flex-col gap-2 2xl:gap-4">
            <div className="bg-white rounded-lg shadow-sm p-2 2xl:p-4 border border-gray-200 flex flex-col flex-1">
            ...
            {warningSubjects.length > 0 && (
              <div 
                className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-2 2xl:p-4 rounded-md shadow-sm" 
                role="alert"
              >
          ...
          <div className="lg:w-2/5 flex flex-col gap-2 2xl:gap-4">
            {(teScore !== null || atar !== null || lowerTeScore !== null || upperTeScore !== null || atarRange !== null) && (
              <div className="bg-white rounded-xl shadow-sm p-2 2xl:p-4 border border-gray-200">
            ...
            {!isGuestMode && (
              <div className="bg-white rounded-lg shadow-sm p-1.5 2xl:p-3 border border-gray-200 flex flex-col flex-1">
            ...
            {isGuestMode && (
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg shadow-md p-3 2xl:p-6 border border-blue-200 text-center flex flex-col flex-1">
                <h3 className="text-base md:text-lg 2xl:text-xl font-semibold text-gray-800 mb-3">Unlock Advanced Features</h3>
                <p className="text-gray-600 mb-4 text-sm 2xl:text-base">
                  Are you a school leader or educator? Subscribe to access powerful tools for in-depth ATAR analysis and student planning:
                </p>
                <ul className="list-disc list-inside text-left text-gray-600 mb-5 space-y-1 pl-4 text-sm 2xl:text-base">
