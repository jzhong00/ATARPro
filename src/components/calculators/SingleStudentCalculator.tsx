  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="container mx-auto p-3">
        ...
        {!isGuestMode && (
          <div className="flex items-center justify-between bg-white rounded-lg shadow-sm p-2 border border-gray-200 mb-3">
        ...
        <div className="flex flex-col lg:flex-row gap-3">
          <div className="lg:w-3/5 flex flex-col gap-3">
            <div className="bg-white rounded-lg shadow-sm p-3 border border-gray-200 flex flex-col flex-1">
            ...
            {warningSubjects.length > 0 && (
              <div 
                className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-3 rounded-md shadow-sm" 
                role="alert"
              >
          ...
          <div className="lg:w-2/5 flex flex-col gap-3">
            ...
            {isGuestMode && (
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg shadow-md p-4 border border-blue-200 text-center flex flex-col flex-1">
                ...
                <ul className="list-disc list-inside text-left text-gray-600 mb-5 space-y-1 pl-4">
